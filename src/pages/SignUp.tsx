...
function SignUp() {
    ...
    return (
        <div className="SignUp flex h-screen">
            {/** Left Banner **/}
            <div className="banner bg-gradient-to-br from-[#006ACB] to-[#003465] p-16 flex flex-col justify-center items-center w-[472px] h-full">
            ...
            {/** Form **/}
            <div className="SignUp-form flex-1 flex items-center justify-center bg-white">
